...
@Component({
  ...
  templateUrl: './wallet-account-componentt.component.html',
  styleUrls: ['./wallet-account-componentt.component.scss'],
})
export class WalletAccountComponentt implements OnInit {
