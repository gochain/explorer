...
type Address struct {
	...
	NumberOfTokenHolders         int       `json:"number_of_token_holders" bson:"number_of_token_holders"`
	NumberOfInternalTransactions int       `json:"number_of_internal_transactions" bson:"number_of_internal_transactions"`
}
