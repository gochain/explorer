set -e
docker run --name test_web3 -d -p 8545:8545 -p 8080:8080 -p 27017:27017 trufflesuite/ganache-cli
...
curl -f http://localhost:8080/api/blocks/10
curl -f http://localhost:8080/api/blocks/10/transactions
